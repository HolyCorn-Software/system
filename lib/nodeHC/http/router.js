...
export class Router {
    ...
    constructor() {
        ...
        /** @type {boolean} This property tells the server to suspend receiving requests */ this.isHalted
    }
    ...
    */
    ...
    doRoute = async (request, ...others) => { //This method is called by the default receiver of requests (it could be firebase)
        ...
        if (contract) {
            ...
            console.warn(`Nothing to route ${request.url}`)
            /** @type {SuperResponse} */
            const response = others.at(-1)
