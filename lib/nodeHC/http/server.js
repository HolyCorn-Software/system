...
export class Server extends Router {
    ...
    set isHalted(value) {
        this[isHalted] = value
        this.websocketServer.isHalted = value
    }
    ...
    async destroy() {
        this.contracts = []
        this.#httpServer.off('request', this[serveMethod])
            ...
            this.route({
                ...
                callback:
                    ...
                    async (request, response) => {
                        ...
                        try {
                            const finUrl = `${remoteURL}${request.url.replace(localPath, '')}`;
                            let data = await fetch(finUrl, {
                                method: request.method,
                                headers: { ...request.headers, ...headers, },
                                body: request.method.toUpperCase() == 'GET' ? undefined : request,
                                redirect: 'follow'
                            })
