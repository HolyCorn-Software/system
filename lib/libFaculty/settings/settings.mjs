...
export default class FacultySettings {
     ...
     * @template {faculty.managedsettings.Namespaces<FacultyName, Name>} Namespace
     * @template {faculty.managedsettings.Names<FacultyName, Namespace>} Name
     * 
     * @param {object} param0
     * @param {Name} param0.name
     * @param {Namespace} param0.namespace
     * @returns {Promise<faculty.managedsettings.Values<FacultyName, Name, Namespace>>}
     */
     ...
     * @param {faculty.managedsettings.SettingsUpdateType<FacultyName, SettingName, Namespace>} param0 
