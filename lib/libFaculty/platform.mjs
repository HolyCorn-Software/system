...
import { FacultyFacultyRemoteMethods } from "../../comm/rpc/faculty-faculty-rpc.mjs";
...
import FacultySettings from "./settings/settings.mjs";
...
export class FacultyPlatform extends Platform {
    ...
    constructor({ descriptor, database, base, connectionManager, server_domains } = {}) {
        ...
        */
        ...
        /** @type {import("./types.js").FacultyDescriptorPlus} */
        this.descriptor;
        ...
        /** @type {import("./settings/types.js").ManagedFacultySettings} */
        this.settings = new FacultySettings(this)
     ...
     * @param {object} param0
     * @param {import("./types.js").FacultyDescriptor} param0.descriptor
