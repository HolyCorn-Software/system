...
export default class PluginModelModel {
    ...
    reloadCredentials() {
        ...
        delete this[lastWorkingCredentials]
    }
    ...
    get publicURL() {
        if (!this.descriptor) {
            // In case this property is being fetched before initialization
            return undefined
        }
    ...
    async getCredentials() {
        ...
        try {
            ...
            return this[lastWorkingCredentials] = currentData
        } catch (e) {
    ...
    /**
     * This optional interface allows the plugin to provide public methods, that other frontend components can call.
     * 
     * For better code-completion, the plugin should define an interface faculty.plugins interface in typescript (.d.ts)
     */
    get remote() {
        return {
            public: {
